...
#define helper_cc_compute_all SYM(helper_cc_compute_all)
#define helper_cc_compute_c SYM(helper_cc_compute_c)
#define helper_write_eflags SYM(helper_write_eflags)
#define helper_read_eflags SYM(helper_read_eflags)
#define helper_clts SYM(helper_clts)
#define helper_reset_rf SYM(helper_reset_rf)
#define helper_cli SYM(helper_cli)
#define helper_sti SYM(helper_sti)
#define helper_clac SYM(helper_clac)
#define helper_stac SYM(helper_stac)
